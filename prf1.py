...
predict_file = "./data/pre_sample.csv"
true_file = "./data/own1.csv"
...
if __name__ == '__main__':
    # own格式处理
    # path = "./data"
    # pd_all = pd.read_csv(os.path.join(path, "own.csv"))
    # a,b = pd_all.label, pd_all.aa
    # own = pd.DataFrame({'a': a, 'b': b})
    # own.to_csv("data/own1.csv", index=False, encoding='utf-8', sep='\t')
    # 计算召回率
